package com.example.utspraktik_if1_10118002_rizkymuslimin;
...
public class Konfirmasi extends AppCompatActivity {
    ...
    private void initCustomDialog(){
        ...
        customDialog = new Dialog(com.example.utspraktik_if1_10118002_rizkymuslimin.Konfirmasi.this);
        customDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        customDialog.setContentView(R.layout.info_tersimpan);
